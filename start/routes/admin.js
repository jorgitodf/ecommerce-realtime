...
Route.group(() => {
    ...
    Route.resource('categories', 'CategoryController').apiOnly().validator(
        new Map([
    ...
    Route.resource('orders', 'OrderController').apiOnly().validator(new Map([[['orders.store'], ['Admin/StoreOrder']]]))
